...
Begin VB.Form frmInputMainSCH 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame FrameA 
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "7、小飞的父母从外地来黄埔做生意，遭到执法人员的不公平对待。对此，你认为小飞的父母应该（ ）"
            BeginProperty Font 
               Name            =   "宋体"
               Size            =   10.5
               Charset         =   134
      ...
      Begin VB.Frame FrameA 
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "4、你在自己居住的社区是否目睹过吸毒、聚众赌博、斗殴等不法行为？（    ）"
            BeginProperty Font 
               Name            =   "宋体"
               Size            =   10.5
               Charset         =   134
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame FrameA 
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "8、目前，黄埔外来务工人员越来越多，对此，你的看法是（     ）"
            BeginProperty Font 
               Name            =   "宋体"
               Size            =   10.5
               Charset         =   134
      ...
      Begin VB.Frame FrameA 
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "9、你认为不正当性行为感染艾滋病是否值得同情？（    ）"
            BeginProperty Font 
               Name            =   "宋体"
               Size            =   10.5
               Charset         =   134
      ...
      Begin VB.Frame FrameA 
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "11、现在有些中小学生过生日时，大摆晏席，邀请同学到饭店庆祝，对此你的看法是：（    ）"
            BeginProperty Font 
               Name            =   "宋体"
               Size            =   10.5
               Charset         =   134
      ...
      Begin VB.Frame FrameA 
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "13、小华为了当上班长，请一些同学到饭店吃饭，以便获得更多的选票。对于这种做法，你认为：（ ）"
            BeginProperty Font 
               Name            =   "宋体"
               Size            =   10.5
               Charset         =   134
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame FrameA 
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "7、你和大家在一起时，是否也觉得自己是孤单的一个人？（     ） "
            BeginProperty Font 
               Name            =   "宋体"
               Size            =   10.5
               Charset         =   134
...
Private Sub saveAnwser()
    ...
    Next
    If Len(strValue) <> 62 Then MsgBox "问卷答案数目出错！", vbCritical, "录入问卷": Exit Sub
